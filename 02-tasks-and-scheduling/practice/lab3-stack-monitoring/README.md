...
โดยทั่วไปคือ Task ที่มีการเรียกฟังก์ชันซ้อนกันลึก หรือ มีตัวแปรโลคัล/บัฟเฟอร์ขนาดใหญ่ (เช่น Task การสื่อสาร Wi-Fi, TCP/IP หรือการเข้ารหัส) เพราะแต่ละการเรียกและตัวแปรโลคัลต้องใช้พื้นที่ Stack

2. การใช้ heap แทน stack มีข้อดีอย่างไร? 📦
ข้อดีคือ ยืดหยุ่น ทำให้สามารถจัดสรร หน่วยความจำขนาดใหญ่ ที่มีขนาดไม่แน่นอนได้ ในขณะรันไทม์ (Runtime) และเหมาะสำหรับการจัดสรรหน่วยความจำที่ต้อง ใช้ร่วมกันระหว่าง Task

3. Stack overflow เกิดขึ้นเมื่อไหร่และทำอย่างไรป้องกัน? 💥
เกิดขึ้นเมื่อ Task ใช้ Stack เกินขนาดที่จัดสรรไว้ ทำให้ข้อมูลไปทับส่วนอื่นและระบบล่ม

ป้องกันโดย: กำหนดขนาด Stack ให้เพียงพอ, หลีกเลี่ยงตัวแปรโลคัลขนาดใหญ่, ใช้ Stack Watermark Monitoring (เช่น uxTaskGetStackHighWaterMark()) และเปิดใช้ Stack Canary

4. การตั้งค่า stack size ควรพิจารณาจากอะไร? 📏
ควรพิจารณาจาก ความลึกของการเรียกฟังก์ชัน ที่ Task นั้นทำ, ขนาดรวมของตัวแปรโลคัล และ Overhead ของ Stack ที่เกิดจากการเรียกฟังก์ชันของระบบปฏิบัติการ (RTOS API)

5. Recursion ส่งผลต่อ stack usage อย่างไร? 📈
Recursion (การเรียกตัวเอง) ส่งผลให้ Stack Usage เพิ่มขึ้นอย่างรวดเร็ว ตามความลึกของการเรียกซ้ำ การเรียกซ้ำที่ลึกเกินไปใน Embedded System ที่ทรัพยากรจำกัดจะทำให้เกิด Stack Overflow ได้อย่างง่ายดาย
